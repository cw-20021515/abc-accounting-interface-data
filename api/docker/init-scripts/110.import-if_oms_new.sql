...
--     FROM '/data/iface/oms_new/if_channel.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_charge.csv'
--     DELIMITER ','
--     CSV HEADER;
--
-- COPY if_charge_invoice(id,charge_id,invoice_id,create_time,update_time)
--     FROM '/data/iface/oms_new/if_charge_invoice.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_charge_item.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_charge_payment.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_contract.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_customer.csv'
--     DELIMITER ','
--     CSV HEADER;
--
-- COPY if_customer(customer_id,email,phone,user_id,last_name,first_name,account_type,customer_status,referrer_code,create_time,update_time)
--     FROM '/data/iface/oms_new/if_customer_vendor.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_invoice.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_material.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_onetime_payment.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_order_item.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_service_charge.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_service_charge_item.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_service_charge_payment.csv'
--     DELIMITER ','
--     CSV HEADER;
--
...
--     FROM '/data/iface/oms_new/if_service_flow.csv'
--     DELIMITER ','
--     CSV HEADER;
